...
<div id="box">
		...
		-->
		  <form name='orderForm'
		  action="<c:url value='/custodio/register' />" method='POST'>

		<table>
			<tr>
				<td>Amount:</td>
				<td><input type='number' step="0.01" min="0.01" max="10000000000" name='amount' required="required"></td>
	...
	<table class="table table-striped">
			...
			<c:forEach var="request" items="${requests}">
				...
				<td align="center">
				  <spring:url value="/public/approve/${request.id}" var="approveUrl" /> 
				                  
				<form:form class="btn btn-danger" method="post" 
                 action="${approveUrl}" >
